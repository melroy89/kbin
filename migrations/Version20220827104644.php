 ...
 */
final class Version20220827104644 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP tags');
        $this->addSql('ALTER TABLE post ALTER ADD TEXT DEFAULT NULL');
