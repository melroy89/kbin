...
#[Table(uniqueConstraints: [new UniqueConstraint(name: 'magazine_name_idx', columns: ['name'])])]
class Magazine implements VisibilityInterface
{
    ...
    #[OneToMany(mappedBy: 'magazine', targetEntity: MagazineLog::class, cascade: ['persist', 'remove'], fetch: 'EXTRA_LAZY')]
    #[OrderBy(['createdAt' => 'DESC'])]
